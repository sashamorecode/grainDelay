...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=grainDelay Demo Installer\n"
      else:
        line="OutputBaseFilename=grainDelay Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the grainDelay Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the grainDelay installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=grainDelay Demo installer\n"
     else:
       line="SetupWindowTitle=grainDelay installer\n"
